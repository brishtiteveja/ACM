...
rb_red_blk_node* TreePredecessor(rb_red_blk_tree*,rb_red_blk_node*);/* returns the predecessor node of the given node*/
rb_red_blk_node* TreeSuccessor(rb_red_blk_tree*,rb_red_blk_node*);/*returns the successor node of the given node*/
